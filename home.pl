...
print $q->start_div({'class' => 'w3-container w3-center w3-padding-32'}), $q->img({'src' => $HTDOCS_PATH.'data/img/ushvam2.png', 'alt' => 'ushvam2', 'width' => '500', 'height' => '200'}), $q->p({'class' => 'w3-large'}, ucfirst($user->getName()).", Welcome to USHVaM 2: You ".$user->isAnalystToString()." and ".$user->isValidatorToString()." and ".$user->isRefereeToString()), "\n",
$q->start_div(), "\n",
