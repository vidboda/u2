...
our @USH3 = ('CLRN1', 'HARS');
our @CHM = ('CHM');
our @DFNB = ('ADCY1', 'ATP2B2', 'CABP2', 'CDC14A', 'CEVA', 'CIB2', 'CLDN9', 'CLDN14', 'CLIC5', 'COL11A2', 'DFNB59', 'ESPN', 'EPS8', 'EPS8L2', 'ESRRB', 'FAM65B', 'FOXI1', 'GIPC3', 'GJB2', 'GJB3', 'GJB6', 'GPSM2', 'GRXCR1', 'GRXCR2', 'HGF', 'ILDR1', 'KARS', 'KCNJ10', 'LHFPL5', 'LOXHD1', 'LRTOMT', 'MARVELD2', 'MPZL2', 'MSRB3', 'MYO3A', 'MYO6', 'MYO15A', 'OTOA', 'OTOF', 'OTOG', 'OTOGL', 'PEX13', 'PDZD7', 'PTPRQ', 'RDX', 'ROR1', 'S1PR2', 'SERPINB6', 'SLC26A4', 'SLC26A5', 'SLITRK6', 'SPNS2', 'STRC', 'SYNE4', 'TBC1D24', 'TECTA', 'TMC1', 'TMEM132E', 'TMIE', 'TMPRSS3', 'TPRN', 'TRIOBP', 'TSPEAR', 'WBP2');
our @DFNA = ('ACTG1', 'CCDC50', 'CD164', 'CEACAM16', 'COCH', 'COL11A2', 'CRYM', 'DIABLO', 'DFNA5', 'DIAPH1', 'DIAPH3', 'DMXL2', 'DSPP', 'EYA4', 'GJB2', 'GJB6', 'GJB3', 'GRHL2', 'HOMER2', 'KCNQ4', 'KITLG', 'MIR96', 'MIR182', 'MIR183', 'MYH9', 'MYH14', 'MYL9', 'MYO1A', 'MYO6', 'NLRP3', 'OSBPL2', 'P2RX2', 'PLS1', 'PTPRQ', 'POU4F3', 'SIX1', 'SLC12A2', 'SLC17A8', 'TBC1D24', 'TECTA', 'TJP2', 'TMC1', 'TNC', 'WFS1','RNR1', 'TRNL1', 'TRNS1', 'VANGL2');
...
sub run_vv {
	...
	#$ua->ssl_opts(verify_hostname => 0);
	#$ua->proxy('https', 'http://194.167.35.151:3128/');
	my $url = "https://www35.lamp.le.ac.uk/VariantValidator/variantvalidator/$genome/$nm:$var/$nm?content-type=application/json";
