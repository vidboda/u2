...
our @NSRP = ('ABCA4', 'AIPL1', 'BBS1', 'BEST1', 'CDHR1', 'CERKL', 'CFAP418', 'CLRN1', 'CNGA1', 'CNGB1', 'CRB1', 'CTSD', 'DHDDS', 'EYS', 'FAM161A', 'FLVCR1', 'IDH3B', 'IMPG2', 'MAK', 'MERTK', 'NBAS', 'NR2E3', 'NRL', 'PCARE', 'PDE6A', 'PDE6B', 'PDE6G', 'PRCD', 'PROM1', 'PRPF31', 'PRPH2', 'RP1', 'RP2', 'RBP3', 'RGR', 'RHO', 'RLBP1', 'RPE65', 'RPGR', 'SAG', 'SNRNP200', 'TTC8', 'USH2A', 'WDR35', 'ZNF513');
our @DFNX = ('AIFM1', 'POU3F4', 'PRPS1', 'SMPX', 'COL4A6');
our @LCA = ('LRAT', 'SPATA7', 'TULP1', 'RPE65');
our @CEVA = ('CEVA');
#our @MITO = ('RNR1', 'TRNL1', 'TRNS1');
our @OTHER_NS = ('ACOX1', 'ACTB', 'ACY1', 'ALMS1', 'ARL6', 'ATP6V0A4', 'ATP6V1B1', 'BSND', 'C1QTNF5', 'CACNA1D', 'CATSPER2', 'CEP76', 'CHD7', 'CISD2', 'COL11A1', 'COL2A1', 'COL4A1', 'COL4A3', 'COL4A4', 'COL4A5', 'COL9A1', 'COL9A2', 'COL9A3', 'COLEC11', 'ECE1', 'EDN3', 'EDNRA', 'EDNRB', 'ERCC2', 'EYA1', 'FGF3', 'FGFR3', 'GATA3', 'HARS2', 'HSD17B4', 'IMPG1', 'JAG1', 'KARS1', 'KCNE1', 'KCNQ1', 'KIT', 'LARS2', 'MASP1', 'MITF', 'MTAP', 'MYO1F', 'NDP', 'NF2', 'OPA1', 'PAX1', 'PAX3', 'PAX6', 'PEX1', 'PEX6', 'PHYH', 'PLS1', 'PMP22', 'POLR1C', 'POLR1D', 'RBP4', 'SEMA3E', 'SIX1', 'SIX5', 'SLC4A11', 'SLC66A1', 'STXBP3', 'SNAI2', 'SOX10', 'SOX2', 'TCOF1', 'TFAP2A', 'TIMM8A', 'TMEM231', 'TNC', 'TOPORS', 'TRPM1', 'TSHZ1', 'TWNK');
...
our $NB_HOMOZYGOUS_VARS_157_TWIST = 420;
our $MEAN_AB_157_TWIST = 0.60;
...
sub standard_begin_html { #prints top of the pages
	...
	print 		$q->end_div(),
		...
		$q->start_div({'class' => 'w3-dropdown-hover'}), "\n",
			...
			$q->start_div({'class' => 'w3-dropdown-content w3-bar-block w3-card-4'}), "\n",
				$q->a({'class' => 'w3-bar-item w3-button w3-ripple w3-large', 'href' => '/perl/U2/stats_ngs.pl'}, 'NGS tables'), "\n",
				$q->a({'class' => 'w3-bar-item w3-button w3-ripple w3-large', 'href' => '/perl/U2/stats_ngs.pl?graph=1'}, 'NGS graphs'), "\n",
...
sub check_illumina_run_id {
	my ($q) = shift;
	if ($q->param('run_id') =~ /^(\d{6}_[A-Z]\d{5}_\d{4}_0{9}-[A-Z0-9]{5})$/o || $q->param('run_id') =~ /^(\d{6}_[A-Z]{2}\d{5,6}_\d{4}_[A-Z0-9]{10})$/o || $q->param('run_id') =~ /^(\d{8}_AV253403_[\w-]+)$/o) {return $1}
