...
sub initConfig {
	return AppConfig->new(
		...
		'ANALYSIS_MINISEQ1' => {ARGCOUNT => 1},
		'ANALYSIS_MINISEQ2' => {ARGCOUNT => 1},
		...
		'NAS_CHU_BASE_DIR' => {ARGCOUNT => 1},
		'NAS_CHU_MINISEQ_BASE_DIR' => {ARGCOUNT => 1},
		'NAS_CHU_MISEQ_BASE_DIR' => {ARGCOUNT => 1},
		'NAS_CHU_AVITI_BASE_DIR' => {ARGCOUNT => 1},
