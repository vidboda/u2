...
if ($q->param('asked') && $q->param('asked') eq 'send2SEAL') {
  ...
  # $ssh->scp_put($TMP_DIR."LRM_seal_json.token", "/home/adminbioinfo/SEAL/seal/static/temp/vcf/".$id.$number."_json.token")
  # $ssh->scp_put($TMP_DIR."MobiDL_seal_json.token", "/home/adminbioinfo/SEAL/seal/static/temp/vcf/".$id.$number."_json.token")
