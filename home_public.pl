...
$text = 'NEWS:<ul><li>2018-10-19: check our new <a href = \'aboutMD.pl\', target = \'_blank\'>About</a> page!</li><li>2018-10-12: when a variant is known in dbSNP, possibility to retrive PubMed articles citing the variant</li><li>2018-10-12 again: added pLi, pRec, pNull values for each gene.</li><li>2018-12-06: You can modify the RNA impact status depending on what you\'ve found.</li><li>2018-12-07: You can export your variant in a DEFGEN compliant csv format using the dedicated button!</li></ul>';
